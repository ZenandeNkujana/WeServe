...
#     if surname == "":
#         print("Enter your surname: ")#not final
...
#Post a job
#========================================
#For someone looking for services/assistance
print("Post a Job")

service = input("What service do you need? ").strip().lower()
description = input("Describe the job: ").strip().lower()#must contain at least 100 wods
location = input("Where is the job located? ").strip().lower
date = input("When is it needed? ").strip()
time = input("What time? ").strip()
budget = input("How nuch are you willing to pay for this job? ").strip()
...
def validate_service(service):
    if service == "":
        print("Please enter the service you need")
    else:
        print(service)
...
def validate_kocation(location):
    if location == "":
